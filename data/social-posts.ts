...
export const instagramPosts = [
  { 
    ...
    caption: "Capturing moments with Pixel 6a - Advanced computational photography in action 📱✨ #TechLife #Pixel6a #ComputerVision",
    likes: 68,
    link: "https://www.instagram.com/om_rode.exe/"
  },
  {
    id: 2,
    image: "/images/gallery/PXL_20250318_082919545~2.jpg",
    caption: "Morning photography session - Testing different angles and lighting 🌅📸 #Photography #MobilePhotography #CreativeProcess",
    likes: 42,
    link: "https://www.instagram.com/om_rode.exe/"
  },
  {
    id: 3,
    image: "/images/gallery/original_e6d8187e-6615-4afd-8027-ba8c4ca03906_PXL_20250115_083743856~2.jpg",
    caption: "Behind the scenes of a tech project - From code to visual storytelling 💻🎬 #TechLife #BehindTheScenes #Engineering",
    likes: 75,
    link: "https://www.instagram.com/om_rode.exe/"
  },
  {
    ...
    caption: "Evening creative session - Where engineering meets art 🌃✨ #CreativeWork #TechPhotography #Innovation",
    likes: 53,
    link: "https://www.instagram.com/om_rode.exe/"
  }
]
...
// 1. For LinkedIn: Copy your post title, excerpt, date, and actual LinkedIn post URL
// 2. For Instagram: Images are now integrated from public/images/gallery/ folder
// 3. Update captions, likes, and Instagram post URLs as needed
// 4. Redeploy your site to see the changes

// Note: Instagram images successfully integrated from insta_post/ folder
